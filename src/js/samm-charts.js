	...
	var model = {
		categories: [
			...
			{category: "V", name: "Verification", img: "V", href: "https://www.owasp.org/index.php/SAMM_-_Verification", color: "darkseagreen", color_dark: "#116D37", practices: [
				...
				{practice: "IR", name: "Implementation Review", img: "IR", href: "https://www.owasp.org/index.php/SAMM_-_Verification#Code_Review", baseHref: "https://www.owasp.org/index.php/SAMM_-_Code_Review",
					activities: [
			...
			{category: "O", name: "Operations", img: "O", href: "https://www.owasp.org/index.php/SAMM_-_Deployment", color: "indianred", color_dark: "#6C0F14", practices: [
				{practice: "IM", name: "Issue Management", img: "IM", href: "https://www.owasp.org/index.php/SAMM_-_Deployment#Vulnerability_Management", baseHref: "https://www.owasp.org/index.php/SAMM_-_Vulnerability_Management",
					activities: [
				...
				{practice: "EH", name: "Environment Hardening", img: "EH", href: "https://www.owasp.org/index.php/SAMM_-_Deployment#Environment_Hardening", baseHref: "https://www.owasp.org/index.php/SAMM_-_Environment_Hardening",
					activities: [
				...
				{practice: "OE", name: "Operational Enablement", img: "OE", href: "https://www.owasp.org/index.php/SAMM_-_Deployment#Operational_Enablement", baseHref: "https://www.owasp.org/index.php/SAMM_-_Operational_Enablement",
					activities: [
